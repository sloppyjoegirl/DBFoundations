...
Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment06DB_DBruce')
	 Begin 
	  Alter Database [Assignment06DB_DBruce] set Single_user With Rollback Immediate;
	  Drop Database Assignment06DB_DBruce;
	 End
	Create Database Assignment06DB_DBruce;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assignment06DB_DBruce;
